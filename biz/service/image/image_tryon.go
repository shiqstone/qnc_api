...
func (s *ImageService) ProcessImageTryOn(req *mimg.ImageTryOnRequest) (resp *mimg.ImageTryOnResponse, err error) {
	...
	resp = new(mimg.ImageTryOnResponse)
...
func PostProcessImageTryOn(base64Content string, width, height int, coordinates []mimg.Coordinate, prompt string, orderId int64) (resp *mimg.ImageTryOnResponse, err error) {
	// process image
...
func prepareTryOnParam(req *mimg.ImageTryOnRequest) (base64Content string, width, height int, coordinates []mimg.Coordinate, prompt string, err error) {
